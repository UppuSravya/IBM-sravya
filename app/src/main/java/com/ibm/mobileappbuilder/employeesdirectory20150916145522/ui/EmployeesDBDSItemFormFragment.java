...
import com.ibm.mobileappbuilder.employeesdirectory20150916145522.presenters.EmployeesFormPresenter;
...
public class EmployeesDBDSItemFormFragment extends FormFragment<EmployeesDBDSItem> {
    ...
    public void onCreate(Bundle state) {
        ...
        setPresenter(new EmployeesFormPresenter(
    ...
    protected int getLayout() {
        return R.layout.employees_form;
    }
