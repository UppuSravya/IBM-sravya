...
public class EmployeesPresenter extends BasePresenter implements ListCrudPresenter<EmployeesDBDSItem>,
    ...
    public EmployeesPresenter(CrudDatasource<EmployeesDBDSItem> crudDatasource,
